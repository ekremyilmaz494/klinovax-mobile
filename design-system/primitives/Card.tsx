...
export const Card = forwardRef<View, CardProps>(function Card(
  ...
  const t = useTheme()
  const bg =
    variant === 'accent' ? t.colors.accent.bgMuted
    : variant === 'warning' ? t.colors.status.warningBg
    : variant === 'success' ? t.colors.status.successBg
    : variant === 'danger' ? t.colors.status.dangerBg
    : t.colors.surface.primary
  const borderColor =
    variant === 'accent' ? t.colors.accent.clay
    : variant === 'warning' ? t.colors.status.warning
    : variant === 'success' ? t.colors.status.success
    : variant === 'danger' ? t.colors.status.danger
